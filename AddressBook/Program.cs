...
namespace AddressBook
{
    class AddressBook
    {
        ...
        public static void EditContact()
        {
            if (People.Count != 0)
            {
                Console.WriteLine("Enter the Name of contact to edit details:");
                ...
                foreach (var person in People)
                {
                    if (person.FirstName.ToUpper() == Modified.ToUpper())
                    {
                        while (true)
                        {
                            Console.WriteLine("Enter the option to modify the Contact: ");
        ...
        public static void ListingPeople()
        {
            ...
            Console.WriteLine("Current Contact's details in your address book:\n");
            foreach (var person in People)
            {
                PrintContact(person);
            }
